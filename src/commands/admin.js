    ...
    bot.command('admin', async (ctx) => {
        try {
            ...
            const buttons = [
                ...
                [Markup.button.callback('🗑 Tarqatmani O\'chirish', 'delete_last_broadcast'), Markup.button.callback('🗑️ Kino o\'chirish', 'admin_delete_movie')],
                [Markup.button.callback('✏️ Kino Tahrirlash', 'admin_edit_movie'), Markup.button.callback('🚫 Ban / Unban', 'admin_ban_unban')],
